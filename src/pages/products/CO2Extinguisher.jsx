...
import { 
  ...
  FaWeightHanging, FaTachometerAlt, FaThermometerHalf, FaCalendarAlt, 
  FaShieldAlt, FaFileDownload, FaChartLine, FaBolt, FaServer
} from 'react-icons/fa';

const CO2Extinguisher = () => {
  ...
  const specs = [
    { icon: <FaWeightHanging />, label: 'Capacity', value: '2kg / 5kg options' },
    { icon: <FaTachometerAlt />, label: 'Working Pressure', value: '50 bar' },
    { icon: <FaChartLine />, label: 'Discharge Time', value: '8-10 seconds' },
    { icon: <FaChartLine />, label: 'Range', value: '2-3 meters' },
    { icon: <FaThermometerHalf />, label: 'Temperature Range', value: '-30°C to +60°C' },
    { icon: <FaCalendarAlt />, label: 'Warranty', value: '5 years' }
  ];

  const features = [
    'Class B & Electrical fires – safe on live equipment',
    'Zero residue – perfect for sensitive electronics',
    'Non-conductive – no risk of short circuits',
    'Lightweight aluminum cylinder for easy handling',
    'Includes horn and sturdy handle',
    'Fast discharge with high cooling effect'
  ];
  ...
  const applications = [
    ...
    'Computer Rooms & IT Closets'
  ];

  const certifications = ['CE Marked', 'BS EN3', 'ISO 9001:2015', 'Marine Approved (option)'];

  return (
    <>
      <Helmet>
        <title>CO₂ Fire Extinguisher | FireSafe</title>
        <meta name="description" content="Clean agent CO₂ extinguisher for electrical fires and Class B fires. Leaves no residue, safe for electronics, non‑conductive." />
      </Helmet>
      ...
      <div className="product-page-enhanced">
        ...
        <div className={`sticky-cta ${scrolled ? 'visible' : ''}`}>
          <div className="container">
            <div className="sticky-content">
              <span className="sticky-title">CO₂ Fire Extinguisher – 2kg / 5kg – Electronics safe</span>
        ...
        <div className="container">
          ...
          <div className="product-hero">
            <div className="hero-badge">⚡ Electronics Safe</div>
            <div className="hero-content">
              <h1>CO₂ Fire Extinguisher</h1>
              <p className="hero-subtitle">Clean agent for electrical & flammable liquid fires</p>
              <div className="hero-rating">
                <span className="stars">★★★★★</span>
                <span className="rating-count">(89 verified reviews)</span>
              </div>
            </div>
          </div>
          ...
          <div className="product-main-grid">
            ...
            <div className="image-gallery">
              <div className="main-image">
                <img 
                  src="/assets/images/CO2Extinguisher.jpg" 
                  alt="CO₂ Fire Extinguisher"
                />
              </div>
              <div className="thumbnails">
                <div className="thumb active">
                  <img src="/assets/images/CO2Extinguisher.jpg" alt="Main" />
                </div>
                <div className="thumb">
            ...
            <div className="product-info-card">
              ...
              <p className="product-description">
                CO₂ fire extinguisher is ideal for protecting sensitive electronic equipment. It leaves no residue, 
                making it perfect for server rooms, data centers, and electrical installations. Non‑conductive 
                and safe on live electrical equipment. Available in 2kg and 5kg options.
              </p>
          ...
          {/* Maintenance & Usage Section */}
          <div className="maintenance-section-enhanced">
            <h3>📋 Maintenance & Usage Guidelines</h3>
            <div className="maintenance-grid">
              <div className="maintenance-item">
                <div className="m-icon">✔️</div>
                <p>Weigh annually to check for gas loss</p>
              </div>
              <div className="maintenance-item">
                <div className="m-icon">✔️</div>
                <p>Inspect horn and hose for damage</p>
              </div>
              <div className="maintenance-item">
                <div className="m-icon">✔️</div>
                <p>Ensure locking pin is intact</p>
              </div>
              <div className="maintenance-item">
                <div className="m-icon">✔️</div>
                <p>Do not touch horn during discharge (cold burn risk)</p>
              </div>
              <div className="maintenance-item">
                <div className="m-icon">✔️</div>
                <p>Check pressure gauge (if fitted) monthly</p>
              </div>
            </div>
          </div>
          ...
          <div className="related-products">
            ...
            <div className="related-grid">
              ...
              <Link to="/products/fm200-system" className="related-card">
                <div className="related-placeholder">⚙️</div>
                <span>FM200 System</span>
              </Link>
            </div>
          </div>
        </div>
...
export default CO2Extinguisher;