...
import { 
  ...
  FaFileDownload, FaChartLine, FaTag, FaFire
} from 'react-icons/fa';

const AFFFoamConcentrate = () => {
  ...
  const specs = [
    ...
    { icon: <FaCalendarAlt />, label: 'Shelf Life', value: '10 years' },
    { icon: <FaThermometerHalf />, label: 'Storage Temp', value: '1°C to 50°C' },
    { icon: <FaChartLine />, label: 'Flash Point', value: '> 100°C' },
    { icon: <FaTag />, label: 'pH Range', value: '6.5 – 8.5' },
    { icon: <FaTint />, label: 'Water Compatibility', value: 'Fresh / Sea / Brackish' }
  ];

  const features = [
    'Class B hydrocarbon fires – rapid fire knockdown',
    'Forms aqueous film to secure flammable vapors',
    'Low viscosity for easy pumping and proportioning',
    'Compatible with fresh, sea, or brackish water',
    'Excellent burnback resistance',
    'UL / FM approved – meets EN 1568'
  ];

  const applications = [
    'Oil Refineries & Petrochemical Plants',
    'Airports (ARFF vehicles & hangars)',
    'Tank Farms & Bulk Storage',
    'Marine Terminals & Offshore Platforms',
    'Fire Departments & Industrial Fire Brigades',
    'Flammable Liquid Spill Protection'
  ];

  const certifications = ['UL Listed', 'FM Approved', 'EN 1568-3', 'ISO 9001:2015', 'CE Marked', 'MED Approved (option)'];

  return (
    <>
      <Helmet>
        <title>AFFF Foam Concentrate | FireSafe</title>
        <meta name="description" content="AFFF foam concentrate for hydrocarbon fires. UL/FM approved, 3% proportioning, 10-year shelf life, compatible with fresh/sea/brackish water." />
      </Helmet>
      ...
      <div className="product-page-enhanced">
        ...
        <div className={`sticky-cta ${scrolled ? 'visible' : ''}`}>
          <div className="container">
            <div className="sticky-content">
              <span className="sticky-title">AFFF Foam Concentrate – 3% / UL FM / 10 year shelf life</span>
        ...
        <div className="container">
          ...
          <div className="product-hero">
            <div className="hero-badge">🔥 UL / FM Approved</div>
            <div className="hero-content">
              <h1>AFFF Foam Concentrate</h1>
              <p className="hero-subtitle">Rapid fire knockdown on hydrocarbon fires</p>
              <div className="hero-rating">
                <span className="stars">★★★★★</span>
                <span className="rating-count">(45 verified reviews)</span>
              </div>
            </div>
          </div>
          ...
          <div className="product-main-grid">
            ...
            <div className="product-info-card">
              ...
              <p className="product-description">
                AFFF (Aqueous Film Forming Foam) concentrate forms an aqueous film on hydrocarbon fuels, 
                providing rapid fire knockdown and securing flammable vapors. Ideal for oil refineries, 
                airports, and tank farms. UL/FM approved and compatible with all water types.
              </p>
              ...
              <div className="trust-badges">
                ...
                <span><FaShieldAlt /> FM Approved</span>
          ...
          <div className="maintenance-section-enhanced">
            ...
            <div className="maintenance-grid">
              ...
              <div className="maintenance-item">
                <div className="m-icon">✔️</div>
                <p>Rotate stock – use oldest first</p>
              </div>
              <div className="maintenance-item">
                <div className="m-icon">✔️</div>
                <p>Sample and test foam quality annually</p>
              </div>
              <div className="maintenance-item">
                <div className="m-icon">✔️</div>
                <p>Do not mix with other foam types unless tested compatible</p>
              </div>
              <div className="maintenance-item">
                <div className="m-icon">✔️</div>
                <p>Protect from freezing – maintain temperature above 1°C</p>
              </div>
            </div>
          </div>
          ...
          <div className="related-products">
            ...
            <div className="related-grid">
              ...
              <Link to="/products/protein-foam" className="related-card">
                <div className="related-placeholder">🌾</div>
                <span>Protein Foam</span>
              </Link>
              <Link to="/products/foam-monitor" className="related-card">
                <div className="related-placeholder">🎯</div>
                <span>Foam Monitor</span>
              </Link>
            </div>
          </div>
        </div>
...
export default AFFFoamConcentrate;